# Gimbal Project Code
Arduino code for a two-axis payload stabilisation system using an MPU6050 as the inertial measurement unit (IMU) and two SG90 servos as actuators. This project includes additional user-friendly features such as LED indicators for debugging and communication, and a mode-switching button.
...
<p align="center">
  ...
  <img src="https://github.com/user-attachments/assets/0148ba3e-8693-4c15-926a-b3b851ecbdb3" alt="Roll PID Control Response" width="45%">
</p>

The gimbal performed well during the simulated flight testing; in testing the antenna only left the inner box for a short period of time. If the gimbal's centre of gravity was lower, such that the antenna was located closer to the pivot point of the table then this may have been prevented.

<p align="center">
  <img src="https://github.com/user-attachments/assets/261fd30f-fab2-4e2e-a694-aa76022a702f" alt="Gimbal Automated Image Processing Results" width="70%">
</p>
